...
def main() -> None:
    if len(sys.argv) != 3:
        print("Usage: enrich-single-entry.py <target_file> <entry_key>", file=sys.stderr)
    ...
    try:
        ...
        if is_enriched:
            ...
            track_enrichment(target_file, entry_key, False, error_msg="No enrichment indicators")
            sys.exit(2)
