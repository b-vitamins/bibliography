...
class EnrichmentOrchestrator:
    ...
    def run(self) -> bool:
        ...
        try:
            ...
            if not self.dry_run:
                self.log(f"Processing {analysis['unenriched_entries']} unenriched entries...", "progress")
    ...
    def _analyze_file(self) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            self.log(f"Analysis complete: {self.enriched_count} enriched, {self.unenriched_count} unenriched", "info")
    ...
    def _process_batches(self, analysis: Dict[str, Any]) -> bool:
        ...
        for i, batch_file in enumerate(batch_files, 1):
            self.log(f"\nProcessing batch {i}/{total_batches}: {Path(batch_file).name}", "progress")
    ...
    def _replace_original(self) -> bool:
        ...
        try:
            ...
            self.log(f"Successfully replaced {self.file_path} with enriched version", "success")
            return True
